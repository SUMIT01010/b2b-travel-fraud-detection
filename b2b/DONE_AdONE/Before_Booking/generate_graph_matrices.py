...
def generate_matrices():
    ...
    # If script is inside Before_Booking or After_booking, the root is two levels up
    if os.path.basename(current_dir) in ['Before_Booking', 'After_booking']:
        base_path = os.path.dirname(os.path.dirname(current_dir))
    elif os.path.basename(current_dir) == 'DONE_AdONE':
    ...
    # Ensure booking matched with itself has zero weight (diagonal = 0)
