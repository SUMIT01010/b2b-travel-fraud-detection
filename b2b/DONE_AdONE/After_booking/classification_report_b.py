...
def generate_report_from_saved_scores(
    ...
    final_output_csv = os.path.join(output_folder_path, 'final_scored_predictions_after_booking.csv')
...
if __name__ == "__main__":
    ...
    saved_csv_path = os.path.join(data_tables_path, 'scored_booking_labels_after_booking.csv')
    
    # 2. Define where you want the markdown report to go
    report_md_path = os.path.join(current_dir, 'classification_report_b.md')
